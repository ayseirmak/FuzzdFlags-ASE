...
tar -czvf exp11-aflvan-O2-fuzz-results.tar.gz -C /users/user42/ fuzz01 fuzz02 fuzz03 fuzz04 fuzz05 fuzzer_stats_summary.csv
tar -czvf exp11-aflvan-O2-fuzz-results-rep1.tar.gz -C /users/user42/ fuzz01
tar -czvf exp11-aflvan-O2-fuzz-results-rep2.tar.gz -C /users/user42/ fuzz02
tar -czvf exp11-aflvan-O2-fuzz-results-rep3.tar.gz -C /users/user42/ fuzz03
tar -czvf exp11-aflvan-O2-fuzz-results-rep4.tar.gz -C /users/user42/ fuzz04
tar -czvf exp11-aflvan-O2-fuzz-results-rep5.tar.gz -C /users/user42/ fuzz05
...
sudo chown -R user42:user42 /users/user42
./extract_fuzz_stat_dir.sh /users/user42
tar -czvf exp12-aflvan-O3-fuzz-results.tar.gz -C /users/user42/ fuzz01 fuzz02 fuzz03 fuzz04 fuzz05 fuzzer_stats_summary.csv
tar -czvf exp12-aflvan-O3-fuzz-results-rep1.tar.gz -C /users/user42/ fuzz01
tar -czvf exp12-aflvan-O3-fuzz-results-rep2.tar.gz -C /users/user42/ fuzz02
tar -czvf exp12-aflvan-O3-fuzz-results-rep3.tar.gz -C /users/user42/ fuzz03
tar -czvf exp12-aflvan-O3-fuzz-results-rep4.tar.gz -C /users/user42/ fuzz04
tar -czvf exp12-aflvan-O3-fuzz-results-rep5.tar.gz -C /users/user42/ fuzz05
